...
<header class="topbar">
    <nav class="nav-links">
        <a href="${pageContext.request.contextPath}/inicio" title="Volver al inicio" style="margin-right: auto; display: flex; align-items: center;">
        ...
        <c:if test="${not empty sessionScope.usuario}">
            <div class="user-profile-nav">
                ...
                <a href="${pageContext.request.contextPath}/MisPedidosController" 
                   ...
                   style="margin: 0 10px; color: #333; text-decoration: none; font-weight: bold; border-bottom: 1px solid transparent; transition: all 0.2s;"
